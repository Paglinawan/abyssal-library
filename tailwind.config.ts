  ...
  theme: {
    extend: {
      colors: {
        ...
        yellow: {
          0: "rgba(255,250,242,1)",
          50: "rgba(255,245,229,1)",
          100: "rgba(255,241,215,1)",
          150: "rgba(255,237,202,1)",
          200: "rgba(255,233,188,1)",
          300: "rgba(254,226,161,1)",
          400: "rgba(254,219,134,1)",
          500: "rgba(253,213,107,1)",
          600: "rgba(251,206,79,1)",
          700: "rgba(246,196,52,1)",
          800: "rgba(237,184,25,1)",
          900: "rgba(230,172,0,1)",
        },
        green: {
